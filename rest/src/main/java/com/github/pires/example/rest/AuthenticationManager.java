...
public class AuthenticationManager {
  ...
  public Response viewMyProfile(@Context HttpHeaders headers) {
    log.info("Tokens total: {}", authService.countTokens());
    log.info("Is authenticated?: {}", authService.isAuthenticated(tokenHeader));
    log.info("Username: {}", authService.getUsername(tokenHeader));
    return Response.ok(authService.getUsername(tokenHeader)).build();
  }
